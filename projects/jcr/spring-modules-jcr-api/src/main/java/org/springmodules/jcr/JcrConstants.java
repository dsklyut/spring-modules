...
public class JcrConstants {
    ...
    protected String resolveName(String namespace, String property) {
        ...
        if (cache) {
            ...
            String result = (String) map.get(property.hashCode());
            // cache miss
            if (result == null)
    ...
    protected void createCache() {
        ...
        // MIX
        jcrCacheMap.put(MIX_LOCKABLE.hashCode(), computeName(
                MIX_NS, MIX_LOCKABLE));
        jcrCacheMap.put(MIX_REFERENCEABLE.hashCode(), computeName(
                MIX_NS, MIX_REFERENCEABLE));
        jcrCacheMap.put(MIX_VERSIONABLE.hashCode(), computeName(
                MIX_NS, MIX_VERSIONABLE));

        // NT
        jcrCacheMap.put(NT_BASE.hashCode(), computeName(NT_NS,
                NT_BASE));
        jcrCacheMap.put(NT_CHILDNODEDEFINITION.hashCode(),
                computeName(NT_NS, NT_CHILDNODEDEFINITION));
        jcrCacheMap.put(NT_FILE.hashCode(), computeName(NT_NS,
                NT_FILE));
        jcrCacheMap.put(NT_FOLDER.hashCode(), computeName(NT_NS,
                NT_FOLDER));
        jcrCacheMap.put(NT_FROZENNODE.hashCode(), computeName(
                NT_NS, NT_FROZENNODE));
        jcrCacheMap.put(NT_HIERARCHYNODE.hashCode(), computeName(
                NT_NS, NT_HIERARCHYNODE));
        jcrCacheMap.put(NT_LINKEDFILE.hashCode(), computeName(
                NT_NS, NT_LINKEDFILE));
        jcrCacheMap.put(NT_NODETYPE.hashCode(), computeName(NT_NS,
                NT_NODETYPE));
        jcrCacheMap.put(NT_PROPERTYDEFINITION.hashCode(),
                computeName(NT_NS, NT_PROPERTYDEFINITION));
        jcrCacheMap.put(NT_QUERY.hashCode(), computeName(NT_NS,
                NT_QUERY));
        jcrCacheMap.put(NT_RESOURCE.hashCode(), computeName(NT_NS,
                NT_RESOURCE));
        jcrCacheMap.put(NT_UNSTRUCTURED.hashCode(), computeName(
                NT_NS, NT_UNSTRUCTURED));
        jcrCacheMap.put(NT_VERSION.hashCode(), computeName(NT_NS,
                NT_VERSION));
        jcrCacheMap.put(NT_VERSIONEDCHILD.hashCode(), computeName(
                NT_NS, NT_VERSIONEDCHILD));
        jcrCacheMap.put(NT_VERSIONHISTORY.hashCode(), computeName(
                NT_NS, NT_VERSIONHISTORY));
        jcrCacheMap.put(NT_VERSIONLABELS.hashCode(), computeName(
